...
describe("Card", () => {
  ...
  describe("styling", () => {
    it("renders the BEM block class on the root", () => {
      ...
      expect(slot(container, "card")?.classList.contains("rp-card")).toBe(true);
    ...
    it("applies the variant modifier class", () => {
      ...
      expect(slot(container, "card")?.classList.contains("rp-card--secondary")).toBe(true);
    ...
    it("defaults to the default variant", () => {
      ...
      expect(slot(container, "card")?.classList.contains("rp-card--default")).toBe(true);
    ...
    it("renders the element classes on the child parts", () => {
      ...
      expect(slot(container, "card-header")?.classList.contains("rp-card__header")).toBe(true);
      expect(slot(container, "card-title")?.classList.contains("rp-card__title")).toBe(true);
      expect(slot(container, "card-content")?.classList.contains("rp-card__content")).toBe(true);
    ...
    it("merges a caller class onto the root", () => {
      ...
      expect(root?.classList.contains("rp-card")).toBe(true);
