...
// it is and offers no way to add an attribute to what came out of it.
//
...
<template>
  <OverlayArrow :class="props.class" data-slot="tooltip-arrow">
    <slot><IconOverlayArrow data-slot="overlay-arrow" /></slot>
  </OverlayArrow>
</template>
