import type { datePickerVariants } from "@ropav/styles";
...
/** Strict: every part of a picker needs the wiring the root holds. */
export const [useDatePickerContext, provideDatePickerContext] = createContext<DatePickerContext>({
