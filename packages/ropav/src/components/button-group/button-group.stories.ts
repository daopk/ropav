    ...
    template: `
      <div class="flex flex-col gap-6">
        <div v-for="item in sizes" :key="item.size" class="flex flex-col gap-2">
          <p class="text-sm text-[var(--rp-muted)]">{{ item.label }}</p>
    ...
    template: `
      <div class="flex flex-col gap-6">
        <div class="flex flex-col gap-2">
          <p class="text-sm text-[var(--rp-muted)]">All buttons disabled</p>
        ...
        <div class="flex flex-col gap-2">
          <p class="text-sm text-[var(--rp-muted)]">Group disabled, but one button overrides</p>
          <ButtonGroup is-disabled>
            <Button>First</Button>
            <Button>
              <ButtonGroupSeparator />
...
export const WithIcons: Story = {
  render: () => ({
    ...
    template: `
      <div class="flex flex-col gap-6">
        <div class="flex flex-col gap-2">
          <p class="text-sm text-[var(--rp-muted)]">With icons</p>
          <ButtonGroup variant="secondary">
            <Button>
              <IconGlobe />
              Search
        ...
        <div class="flex flex-col gap-2">
          <p class="text-sm text-[var(--rp-muted)]">Icon only buttons</p>
  ...
  render: () => ({
    ...
    template: `
      <div class="flex flex-col items-start gap-8">
        <div class="flex flex-col gap-2">
          <p class="text-sm text-[var(--rp-muted)]">Single button with dropdown</p>
          <ButtonGroup>
        ...
        <div class="flex flex-col gap-2">
          <p class="text-sm text-[var(--rp-muted)]">Individual buttons</p>
        ...
        <div class="flex flex-col gap-2">
          <p class="text-sm text-[var(--rp-muted)]">Previous/Next navigation</p>
          <ButtonGroup variant="tertiary">
            <Button>
              <IconChevronLeft />
              Previous
        ...
        <div class="flex flex-col gap-2">
          <p class="text-sm text-[var(--rp-muted)]">Content selection</p>
          <ButtonGroup variant="tertiary">
            <Button>
              <IconPicture />
              Photos
        ...
        <div class="flex flex-col gap-2">
          <p class="text-sm text-[var(--rp-muted)]">Text alignment</p>
          <ButtonGroup variant="tertiary">
            <Button>Left</Button>
            <Button>
              <ButtonGroupSeparator />
        ...
        <div class="flex flex-col gap-2">
          <p class="text-sm text-[var(--rp-muted)]">Icon-only alignment</p>
          <ButtonGroup variant="tertiary">
            <Button aria-label="Align left" is-icon-only>
              <IconTextAlignLeft />
            </Button>
