    ...
    setup: () => ({
      variants: [
        ...
        },
        {
          ...
          description: "Standard card appearance (--rp-surface)",
          title: "Default",
          variant: "default",
        },
        {
          body: "Use to draw moderate attention",
          description: "Medium prominence (--rp-surface-secondary)",
          title: "Secondary",
          variant: "secondary",
        },
        {
          body: "Use for primary or featured content",
          description: "Higher prominence (--rp-surface-tertiary)",
          title: "Tertiary",
          variant: "tertiary",
        },
      ],
    ...
    template: `
      <Card class="w-full items-stretch md:flex-row" v-bind="args">
        <img
          ...
          class="pointer-events-none aspect-square w-full rounded-[calc(var(--rp-radius)*3)] object-cover select-none md:max-w-[136px]"
          loading="lazy"
          :src="src"
        />
          ...
          <CardFooter class="mt-auto flex w-full flex-row items-center justify-between">
            <div class="flex flex-col">
              <span
                ...
                class="text-sm font-medium text-[var(--rp-foreground)]"
              >
                $36,799
              </span>
              <span aria-label="Available stock: 11 units" class="text-xs text-[var(--rp-muted)]">
                11 available
              </span>
            </div>
    ...
    template: `
      <div class="flex gap-4">
        ...
        >
          <img
            :alt="community.alt"
            class="pointer-events-none aspect-square w-14 rounded-[calc(var(--rp-radius)*2)] object-cover select-none"
            loading="lazy"
            :src="community.cover"
          />
          <CardHeader>
      ...
      <div class="flex w-full items-center justify-center">
        <div class="grid w-full max-w-2xl grid-cols-12 gap-4 p-4">
          <Card class="col-span-12 flex h-auto min-h-[152px] flex-col sm:flex-row" v-bind="args">
            <div class="relative h-[140px] w-full shrink-0 overflow-hidden rounded-[calc(var(--rp-radius)*2)] sm:h-[120px] sm:w-[120px]">
              <img
                alt="Cherries"
            ...
            <div class="flex flex-1 flex-col gap-3">
              ...
              <CardFooter class="mt-auto flex w-full flex-col items-start gap-3 sm:flex-row sm:items-center sm:justify-between">
                <div class="flex flex-col">
                  <span class="text-sm font-medium text-[var(--rp-foreground)]">Only 10 spots</span>
                  <span class="text-xs text-[var(--rp-muted)]">Submission ends Oct 10.</span>
                </div>
            ...
            <div class="col-span-12 grid grid-cols-12 gap-4 lg:col-span-6">
              <Card class="col-span-12">
                ...
                <CardHeader class="gap-3">
                  ...
                  <div class="flex flex-col gap-1">
                    <span class="text-xs font-medium text-[var(--rp-muted)] uppercase">PAYMENT</span>
              ...
              <div class="col-span-12 grid grid-cols-12 gap-4">
                <Card class="col-span-12 gap-2 sm:col-span-6">
                  <CardHeader>
                    <Avatar class="size-[56px] rounded-[calc(var(--rp-radius)*1.5)]">
                  ...
                  <CardContent class="mt-1">
                    ...
                    <p class="text-xs text-[var(--rp-muted)]">148 members</p>
                  </CardContent>
                  <CardFooter class="flex items-center gap-2">
                    ...
                    <p class="text-xs text-[var(--rp-muted)]">By John</p>
                  </CardFooter>
                </Card>
                <Card class="col-span-12 gap-2 sm:col-span-6">
                  <CardHeader>
                  ...
                  <CardContent class="mt-1">
                    ...
                    <p class="text-xs text-[var(--rp-muted)]">362 members</p>
                  </CardContent>
                  <CardFooter class="flex items-center gap-2">
                    <Avatar class="size-4">
                    ...
                    <p class="text-xs text-[var(--rp-muted)]">By Martha</p>
                  </CardFooter>
                </Card>
              </div>
            </div>

            <Card class="col-span-12 min-h-[200px] rounded-[calc(var(--rp-radius)*3)] lg:col-span-6" v-bind="args">
              <img
                alt="NEO Home Robot"
                aria-hidden="true"
            ...
            <div class="col-span-12 flex flex-col gap-2 md:col-span-4 md:justify-between md:gap-0">
              <Card class="flex flex-row gap-3 p-1" variant="transparent">
                <img
                  ...
                  class="aspect-square h-16 w-16 shrink-0 rounded-[calc(var(--rp-radius)*1.5)] object-cover select-none sm:h-20 sm:w-20"
                  loading="lazy"
      ...
      <Card class="w-full max-w-md" v-bind="args">
        ...
        <Form @submit="onSubmit">
          ...
          <CardFooter class="mt-4 flex flex-col gap-2">
            ...
            <p v-if="submitted !== null" class="text-sm text-[var(--rp-muted)]">
