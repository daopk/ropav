        ...
        <DropdownPopover>
          <DropdownMenu>
            ...
            <DropdownItem id="open-file" text-value="Open file">
              <IconFolderOpen class="size-4 shrink-0 text-[var(--rp-muted)]" />
            ...
            <DropdownItem id="save-file" text-value="Save file">
              <IconFloppyDisk class="size-4 shrink-0 text-[var(--rp-muted)]" />
  ...
  render: () => ({
    ...
    template: `
      <Dropdown>
        <DropdownTrigger
          aria-label="Menu"
          class="rp-button rp-button--md rp-button--secondary rp-button--icon-only data-[focus-visible=true]:status-focused"
        >
          ...
          <DropdownMenu>
            ...
            <DropdownSubmenuTrigger>
              <DropdownItem id="share" text-value="Share">
                ...
                <DropdownSubmenuIndicator>
                  <IconArrowRight class="size-3.5 text-[var(--rp-muted)]" />
                </DropdownSubmenuIndicator>
              </DropdownItem>
              <DropdownPopover>
                <DropdownMenu>
                  ...
                  <DropdownSubmenuTrigger>
                    <DropdownItem id="email" text-value="Email">
                      ...
                      <DropdownSubmenuIndicator>
                        <svg
                          class="size-3.5 text-[var(--rp-muted)]"
                          fill="none"
                          stroke="currentColor"
          ...
          <div class="px-3 pt-3 pb-1">
            <div class="flex items-center gap-2">
              ...
              <div class="flex flex-col gap-0">
                ...
                <p class="text-xs leading-none text-[var(--rp-muted)]">jane@example.com</p>
              </div>
            </div>
          </div>
          <DropdownMenu>
            ...
            <DropdownItem id="settings" text-value="Settings">
              <div class="flex w-full items-center justify-between gap-2">
                ...
                <IconGear class="size-3.5 text-[var(--rp-muted)]" />
              </div>
            </DropdownItem>
            <DropdownItem id="new-project" text-value="New project">
              <div class="flex w-full items-center justify-between gap-2">
                <Label>Create Team</Label>
                <IconPersons class="size-3.5 text-[var(--rp-muted)]" />
              </div>
            </DropdownItem>
            <DropdownItem id="logout" text-value="Logout" variant="danger">
              <div class="flex w-full items-center justify-between gap-2">
                <Label>Log Out</Label>
                <IconArrowRightFromSquare class="size-3.5 text-[var(--rp-danger)]" />
              </div>
            </DropdownItem>
          </DropdownMenu>
        </DropdownPopover>
