...
<template>
  <span aria-label="Loading" :class="styles" data-slot="spinner" role="status">
    <svg
      aria-hidden="true"
    ...
    >
      <defs>
        <linearGradient :id="headGradientId" x1="50%" x2="50%" y1="5.271%" y2="91.793%">
          <stop offset="0%" stop-color="currentColor" />
          <stop offset="100%" stop-color="currentColor" stop-opacity="0.55" />
        </linearGradient>
        <linearGradient :id="tailGradientId" x1="50%" x2="50%" y1="15.24%" y2="87.15%">
