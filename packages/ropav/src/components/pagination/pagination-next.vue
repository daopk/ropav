...
import type { PaginationLinkSlotProps, PaginationNextProps } from "./pagination.types";
...
const props = withDefaults(defineProps<PaginationNextProps>(), { type: "button" });
...
<template>
  <button
    :class="slots.link({ class: props.class, isNav: true })"
