...
import type {PaginationLinkProps, PaginationLinkSlotProps} from "./pagination.types";
...
const props = withDefaults(defineProps<PaginationLinkProps>(), {type: "button"});
...
<template>
  <button
    ...
    :class="slots.link({class: props.class})"
