        ...
        <ModalBackdrop>
          <ModalContainer>
            <ModalDialog class="sm:max-w-[360px]">
              <ModalCloseTrigger />
              <ModalHeader>
                <ModalIcon class="bg-[var(--rp-default)] text-[var(--rp-foreground)]">
          ...
          <ModalContainer>
            <ModalDialog class="sm:max-w-[360px]">
              <ModalHeader class="items-center text-center">
                <ModalIcon class="bg-[var(--rp-accent-soft)] text-[var(--rp-accent-soft-foreground)]">
            ...
            <ModalBackdrop>
              <ModalContainer>
                <ModalDialog v-slot="{ close }" class="sm:max-w-[360px]">
                  <ModalHeader>
                    <ModalIcon class="bg-[var(--rp-success-soft)] text-[var(--rp-success-soft-foreground)]">
      ...
      <div class="flex max-w-md flex-col gap-8">
        <div class="flex flex-col gap-3">
          ...
          <p class="text-sm leading-relaxed text-pretty text-[var(--rp-muted)]">
            Control the modal with a plain <code class="text-[var(--rp-foreground)]">shallowRef</code> for
          ...
          <ModalContainer placement="auto">
            <ModalDialog class="sm:max-w-md">
              ...
              <ModalHeader>
                ...
                <p class="mt-1.5 text-sm leading-5 text-[var(--rp-muted)]">
  ...
  render: () => ({
    ...
    template: `
      <Modal>
        ...
        >
          <div
            class="flex size-12 shrink-0 items-center justify-center rounded-[calc(var(--rp-radius)*1.5)] bg-[var(--rp-accent-soft)] text-[var(--rp-accent-soft-foreground)]"
          >
            <IconGear class="size-6" />
          </div>
          <div class="flex flex-1 flex-col gap-0.5">
            <p class="text-sm font-semibold">Settings</p>
            <p class="text-xs text-[var(--rp-muted)]">Manage your preferences</p>
          </div>
        </ModalTrigger>
        <ModalBackdrop>
          <ModalContainer>
