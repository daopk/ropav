...
const AppleShowcaseButton = {
  ...
  template: `
    <Button
      :class="[
        'h-14 rounded-full bg-[#1e1e20] text-[17px] text-[#f5f5f7] duration-[400ms] ease-[cubic-bezier(0.455,0.03,0.515,0.955)] hover:bg-[#272729]',
      ...
      <section class="w-full overflow-hidden bg-[var(--surface)]">
        <div class="flex w-full items-center gap-8 px-8 py-8">
          ...
          >
            <Button
              aria-label="Previous disclosure"
              class="rounded-full transition-all duration-250 ease-[ease]"
              is-icon-only
              :is-disabled="isPrevDisabled"
              variant="secondary"
              @click="onPrevious"
