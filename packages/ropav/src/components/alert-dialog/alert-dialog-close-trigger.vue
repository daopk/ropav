 ...
 *
 * `CloseButton` already names itself, and a declared prop would be bound on every render — as
...
<template>
  <CloseButton :class="styles" data-slot="alert-dialog-close-trigger" @click="onClick" />
</template>
