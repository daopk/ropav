    ...
    template: `
      <div class="flex flex-col gap-6">
        <div class="flex flex-col gap-2">
          <p class="text-sm text-[var(--rp-muted)]">Default hover underline</p>
          <Link href="#">
        ...
        <div class="flex flex-col gap-2">
          <p class="text-sm text-[var(--rp-muted)]">Always visible underline</p>
        ...
        <div class="flex flex-col gap-2">
          <p class="text-sm text-[var(--rp-muted)]">No underline</p>
        ...
        <div class="flex flex-col gap-2">
          <p class="text-sm text-[var(--rp-muted)]">Changing the underline offset</p>
    ...
    template: `
      <RouterProvider :is-current="isCurrent" :navigate="navigate">
        <div class="flex flex-col gap-6">
          ...
          <div class="flex flex-col gap-2">
            <p class="text-sm text-[var(--rp-muted)]">The browser keeps these:</p>
            <div class="flex items-center gap-4">
              <Link
                href="https://github.com/daopk/ropav"
                rel="noopener noreferrer"
