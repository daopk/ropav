    ...
    template: `
      <div class="flex items-start gap-8">
        <div v-for="orientation in orientations" :key="orientation" class="flex flex-col gap-2">
          <p class="text-sm text-[var(--rp-muted)]">{{ orientation }}</p>
    ...
    template: `
      <div class="flex flex-col gap-6">
        <div class="flex flex-col gap-2">
          <p class="text-sm text-[var(--rp-muted)]">Attached (default)</p>
        ...
        <div class="flex flex-col gap-2">
          <p class="text-sm text-[var(--rp-muted)]">Detached</p>
...
export const SelectionMode: Story = {
  render: () => ({
    ...
    template: `
      <div class="flex flex-col gap-6">
        <div class="flex flex-col gap-2">
          <p class="text-sm text-[var(--rp-muted)]">Single selection</p>
        ...
        <div class="flex flex-col gap-2">
          <p class="text-sm text-[var(--rp-muted)]">Multiple selection</p>
          <ToggleButtonGroup
  ...
  render: () => ({
    ...
    template: `
      <div class="flex flex-col gap-6">
        ...
        <div class="flex flex-col gap-2">
          <p class="text-sm text-[var(--rp-muted)]">Individual button disabled</p>
          <ToggleButtonGroup selection-mode="multiple">
            <ToggleButton aria-label="Bold" id="bold" is-icon-only>
              <IconBold />
            </ToggleButton>
  ...
  render: () => ({
    ...
    template: `
      <div class="flex flex-col items-start gap-8">
        <div class="flex flex-col gap-2">
          <p class="text-sm text-[var(--rp-muted)]">Text formatting toolbar</p>
        ...
        <div class="flex flex-col gap-2">
          <p class="text-sm text-[var(--rp-muted)]">View mode switcher</p>
          <ToggleButtonGroup
        ...
        <div class="flex flex-col gap-2">
          <p class="text-sm text-[var(--rp-muted)]">Vertical toolbar</p>
