...
const page = `
  <SidebarInset>
    <div class="flex items-center gap-3 border-b border-[var(--rp-separator)]/50 p-4">
      <SidebarTrigger />
      <span class="text-sm font-medium">Inbox</span>
    </div>
    <div class="p-4 text-small text-[var(--rp-muted)]">Page content</div>
  </SidebarInset>
`;
...
const nav = `
  <SidebarHeader v-slot="{ isCollapsed }">
    <span class="flex h-8 items-center gap-2 px-1.5 text-sm font-semibold">
      <span class="flex size-5 shrink-0 items-center justify-center rounded-[calc(var(--rp-radius)*0.5)] bg-[var(--rp-accent)] text-xs text-[var(--rp-accent-foreground)]">A</span>
  ...
  <SidebarContent>
    <SidebarGroup>
      ...
      <SidebarItem href="#">
        ...
        <SidebarItemTrailing><span class="text-xs text-[var(--rp-muted)]">12</span></SidebarItemTrailing>
      </SidebarItem>
      <SidebarItem href="#">
...
const meta: StoryMeta = {
  ...
  decorators: [
    () => ({
      template:
        '<div class="h-[32rem] w-[52rem] max-w-full overflow-hidden rounded-[calc(var(--rp-radius)*1)] border border-[var(--rp-separator)]/50"><story /></div>',
    }),
  ],
  parameters: {
    layout: "centered",
...
const onPage = () => ({
  template: '<div class="size-full bg-[var(--rp-background)]"><story /></div>',
});
    ...
    template: `
      <Sidebar collapsible="icon">
        <SidebarPanel>
          <SidebarHeader v-slot="{ isCollapsed }">
            <span class="flex h-8 items-center gap-2 px-1.5 text-sm font-semibold">
              <span class="flex size-5 shrink-0 items-center justify-center rounded-[calc(var(--rp-radius)*0.5)] bg-[var(--rp-accent)] text-xs text-[var(--rp-accent-foreground)]">R</span>
          ...
          <SidebarContent>
            ...
            <SidebarGroup>
              ...
              <SidebarItem href="#">
                ...
                <SidebarItemTrailing><span class="text-xs text-[var(--rp-muted)]">3</span></SidebarItemTrailing>
              </SidebarItem>
            </SidebarGroup>
          </SidebarContent>
          <SidebarFooter>
