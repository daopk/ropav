...
export const ChannelEditing: Story = {
  render: () => ({
    ...
    template: `
      <div class="flex flex-col gap-4">
        <p class="text-sm text-[var(--rp-muted)]">Edit individual HSL channels:</p>
        <div class="flex gap-4">
          ...
          >
            ...
            <ColorFieldGroup>
              <ColorFieldInput />
              <ColorFieldSuffix>
                <span class="text-sm text-[var(--rp-muted)]">%</span>
              </ColorFieldSuffix>
            </ColorFieldGroup>
          </ColorField>
          <ColorField
...
export const RGBChannels: Story = {
  render: () => ({
    ...
    template: `
      <div class="flex flex-col gap-4">
        <p class="text-sm text-[var(--rp-muted)]">Edit individual RGB channels:</p>
        <div class="flex gap-4">
          <ColorField
            channel="red"
            class="w-[80px]"
