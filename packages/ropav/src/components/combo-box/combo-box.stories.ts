    ...
    return {
      ...
      template: `
        <div class="space-y-2">
          ...
          <p class="text-sm text-[var(--rp-muted)]">Input value: {{ inputValue || "(empty)" }}</p>
        </div>
      `,
    };
  },
    ...
    template: `
      <div class="flex flex-col gap-8">
        <div class="flex flex-col gap-2">
          <p class="text-sm font-medium text-[var(--rp-muted)]">Focus (default)</p>
          <ComboBox
            v-slot="{items: matches}"
            class="w-[256px]"
            :item-text-value="byName"
        ...
        <div class="flex flex-col gap-2">
          <p class="text-sm font-medium text-[var(--rp-muted)]">Input</p>
          <ComboBox
            v-slot="{items: matches}"
            class="w-[256px]"
            :item-text-value="byName"
        ...
        <div class="flex flex-col gap-2">
          <p class="text-sm font-medium text-[var(--rp-muted)]">Manual</p>
          <ComboBox
            v-slot="{items: matches}"
            class="w-[256px]"
            :item-text-value="byName"
      ...
      >
        ...
        <ComboBoxValue class="flex flex-wrap gap-2">
          <template #default="{isPlaceholder, selectedItems}">
            <span v-if="isPlaceholder" class="text-sm text-[var(--rp-muted)]">No animals selected</span>
