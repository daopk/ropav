      ...
      "/components/": [
        { items: [{ link: "/components/", text: "All components" }], text: "Overview" },
        {
          items: [
            ...
            { link: "/components/button-group", text: "ButtonGroup" },
            { link: "/components/toggle-button-group", text: "ToggleButtonGroup" },
          ],
          text: "Buttons",
        },
        {
          items: [
            ...
            { link: "/components/checkbox-group", text: "CheckboxGroup" },
            { link: "/components/fieldset", text: "Fieldset" },
          ],
          text: "Forms",
        },
        {
          items: [
            ...
            { link: "/components/date-range-picker", text: "DateRangePicker" },
            { link: "/components/date-field", text: "DateField" },
            { link: "/components/time-field", text: "TimeField" },
            { link: "/components/calendar", text: "Calendar" },
            { link: "/components/range-calendar", text: "RangeCalendar" },
          ],
          text: "Pickers",
        },
        {
        ...
        },
        {
          items: [
            ...
            { link: "/components/separator", text: "Separator" },
          ],
        ...
        },
        {
          items: [
            ...
            { link: "/components/color-slider", text: "ColorSlider" },
            { link: "/components/color-field", text: "ColorField" },
            { link: "/components/color-swatch-picker", text: "ColorSwatchPicker" },
          ],
          text: "Colors",
        },
