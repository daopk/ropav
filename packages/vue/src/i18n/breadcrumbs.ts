...
export type BreadcrumbsStringKey = "breadcrumbs";

/**
 * Localized strings for breadcrumbs, copied from react-aria 3.51.0
 * (`packages/react-aria/intl/breadcrumbs/*.json`).
 */
export const breadcrumbsStrings: LocalizedStrings<BreadcrumbsStringKey, string> = {
