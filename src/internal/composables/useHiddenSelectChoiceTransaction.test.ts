...
import {
    useHiddenSelectChoiceTransaction,
    type HiddenSelectChoiceTransaction,
} from './useHiddenSelectChoiceTransaction';

type SingleValue = string | number | null;

describe('useHiddenSelectChoiceTransaction', () => {
    ...
    it('restores an uncontrolled default on reset and redirects native invalid focus', async () => {
        ...
        let transaction!: HiddenSelectChoiceTransaction<string[]>;
        ...
        const container = mountDom(
            defineComponent({
                setup() {
                    ...
                    transaction = useHiddenSelectChoiceTransaction<string[]>({
                        value: {
